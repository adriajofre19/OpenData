...
const props = defineProps(['plans', 'user', 'categories']);
...
const submit = () => {
    ...
    form.post('/adminpanel/addplan', formData);
};
...
<template>
    ...
    <div class="p-6 mt-14 sm:ml-40">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-white uppercase bg-gray-800 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Data d'inici</th>
        ...
        <div class="mt-4">
            <button @click="cleanForm()" data-modal-target="addplan-modal" data-modal-toggle="addplan-modal" class="text-white inline-flex items-center bg-gray-900  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <div id="addplan-modal" tabindex="-2" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5" @submit.prevent="submit" enctype="multipart/form-data">
