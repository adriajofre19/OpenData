    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Actualitzeu la informació del perfil i l'adreça electrònica del vostre compte.
            </p>
        </header>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                ...
                >
                    S'ha enviat un enllaç de verificació nou a la vostra adreça de correu electrònic.
                </div>
            </div>
